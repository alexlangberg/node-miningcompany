...
var Miningcompany = function(maps, options) {
  ...
  _this._krawler = new Krawler(options.krawler);
 ...
 * @param {(object|object[])} maps
 */
Miningcompany.prototype.mine = function(maps) {
  var _this = this;
  var cart;
  _this.emit('mine');
  ...
  _this._krawler
    ...
    .on('end', function() {
      ...
      _this.emit('cart', cart, s);
    });

  _this._krawler.queue(maps);
};
